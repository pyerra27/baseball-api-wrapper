"""
Tests for baseball_api_wrapper.modules.teams
==============================
...
from baseball_api_wrapper.modules.teams import get_teams, MLB_SPORT_ID
...
class TestGetTeams(unittest.TestCase):
    ...
    def test_creates_default_client_when_none_provided(self):
        ...
        with patch("baseball_api_wrapper.modules.teams.MLBStatsClient") as MockClient:
            ...
            with patch("baseball_api_wrapper.modules.teams.MLBStatsClient") as MC:
